...
replace open-cluster-management.io/sdk-go => github.com/morvencao/ocm-sdk-go v0.0.0-20240828080104-dbacf24fbadb

replace open-cluster-management.io/ocm => github.com/morvencao/ocm v0.0.0-20240826140244-f8fd4c5ffabb
