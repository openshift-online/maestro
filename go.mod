...
replace (
	open-cluster-management.io/ocm => github.com/morvencao/ocm v0.0.0-20251112090631-09a2c3ec0e34
	open-cluster-management.io/sdk-go => github.com/morvencao/ocm-sdk-go v0.0.0-20251111131542-2463b9d4ca1a
)
