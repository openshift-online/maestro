...
import (
	...
	"github.com/openshift-online/maestro/cmd/maestro/mcp"
...
func main() {
	...
	mcpCmd := mcp.NewMCPCommand()

	// Add subcommand(s)
	rootCmd.AddCommand(migrateCmd, serveCmd, agentCmd, consumerCmd, resourceBundleCmd, mcpCmd)
